...
all: $(SRCFILES:src/%.c=obj/%.o)
	$(CC) $(CFLAGS) obj/controller.o obj/mq_utils.o obj/shm_utils.o obj/menu.o obj/structs.o -o bin/controller_bin -I$(INCFOLDER)
	$(CC) $(CFLAGS) obj/sensor_simulator.o obj/mq_utils.o obj/shm_utils.o obj/menu.o obj/structs.o -o bin/sensor_simulator_bin -I$(INCFOLDER)
	$(CC) $(CFLAGS) obj/instrument_cluster.o obj/mq_utils.o obj/shm_utils.o obj/menu.o obj/structs.o -o bin/instrument_cluster_bin -I$(INCFOLDER)
